...
module.exports = (sequelize, DataTypes) => {
  ...
  Karyawan.associate = function(models){
    ...
    Karyawan.hasMany(models.HLaporanMixerPipa,{foreignKey: 'idPelapor', as: 'hMixerPipaKaryawan'})
    Karyawan.hasMany(models.HLaporanMixerPipa,{foreignKey: 'idKetua', as: 'hMixerPipaKetua'})
